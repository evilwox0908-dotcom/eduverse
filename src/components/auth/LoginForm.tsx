  ...
  const formatFirebaseError = (code: string) => {
    switch (code) {
      ...
      case 'auth/too-many-requests':
        return 'Access temporarily blocked due to many failed attempts. Try again later or reset password.';
      ...
      case 'auth/cancelled-popup-request':
        return 'Google sign-in was interrupted. Please click Continue with Google again.';
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <button
              ...
              className="text-xs font-semibold text-blue-600 hover:text-blue-700 focus:outline-none hover:underline cursor-pointer"
            >
              Forgot password?
            </button>
          </div>
